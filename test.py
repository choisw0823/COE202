    ...
    def action(self, state):
        ...
        for mi, mp in enumerate(my_positions):
            ...
            for i, ys in enumerate(available_yutscores):
                prev_next_m, prev_next_e = my_positions, enemy_positions
                for shortcut in [True, False]:
                    ...
                    if legal_move:
                        if len(available_yutscores) == 1:
                            ...
                            print(next_my_positions, next_enemy_positions, available_yutscores[(i+1):], scores[-1])
...
if __name__ == "__main__":
    ...
    p2 = MyPlayer()
    print(p2.action((0, (0,0,0,5), (0,0,0,0), [4,3])))